...
<body>
            ...
            <div id="content" class="bg-light w-100">
                ...
                <div class="container">
                    ...
                    <section id="refresh_table">
                        <table class="table table-responsive-sm table-hover" id="tabla_equipos_faltantes">
    ...
    <div class="modal fade" id="modal_reintegrar_f" tabindex="-1" role="dialog" aria-labelledby="modal2"
        aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="modal2">¿Desea reintegrar este equipo?</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    <form action="../consultas/faltante_reintegrar.php" onsubmit="return validar_reintegrar();" id="form_faltante" method="post">
                        <div id="msj_error_falt"></div>
                                <div>
                                    <label for="id_falt" class="col-form-label">Equipo:</label>
                                    <input type="text" name="id_falt" id="id_falt" readonly required>
                                </div>
                                <div>
                                    <label for="nombre_con_f" class="col-form-label">Contrato:</label>
                                    <input type="text" name="nombre_con_f" id="nombre_con_f" readonly>        
                                </div>
                                <div>
                                    <label for="nombre_per_f" class="col-form-label">Perfil:</label>
                                    <input type="text" name="nombre_per_f" id="nombre_per_f" readonly>
                                </div>
                                <div class="pb-4 pt-3">
                                    <span>Este equipo volvera a la etapa de <b style="font-weight: bold">Asignación de ID institucional.</b></span>
                                </div>
...
<div class="modal fade bd-example" id="modal_historial" tabindex="-1" role="dialog" aria-labelledby="modal4"
    ...
    <script type="text/javascript" src="../js/tabla_faltante.js"></script>
