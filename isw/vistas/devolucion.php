...
<body>
            ...
            <div id="content" class="bg-light w-100">
                ...
                <div class="container">
                                ...
                                ?>
                                    ...
                                    ?>
                                        <div class="alert alert-danger alert-dismissible fade show" role="alert">
                                            Error al asignar equipo como equipo nuevo
                    ...
                    <section id="refresh_table">
                        <table class="table table-responsive-sm table-hover" id="tabla_equipos_devolucion">
    ...
    <!--MODAL EQUIPO PARA REINTEGRAR DEVUELTO -->
    <div class="modal fade" id="modal_reintegrar_d" tabindex="-1" role="dialog" aria-labelledby="modal2"
        aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="../consultas/devolucion_reintegrar.php" id="form_de" method="post">
                        <div id="msj_error_falt"></div>
                                <div>
                                    <label for="id_dev" class="col-form-label">Equipo:</label>
                                    <input type="text" name="id_dev" id="id_dev" readonly>
                                </div>
                                <div>
                                ...
                                <div>
                                    <label for="nombre_per_d" class="col-form-label">Perfil:</label>
                                    <input type="text" name="nombre_per_d" id="nombre_per_d" readonly>
                                </div>
                                <div class="pb-4 pt-3">
                                <span>Este equipo volvera a la etapa de <b style="font-weight: bold">Asignación ID institucional ¿Estás seguro?</b> </span>
                                    <input type="text" name="id_equipo" id="id_equipo" style="display: none;" readonly>
                                </div>
...
<div class="modal fade bd-example" id="modal_historial" tabindex="-1" role="dialog" aria-labelledby="modal4"
    ...
    <script type="text/javascript" src="../js/tabla_dev.js"></script>
