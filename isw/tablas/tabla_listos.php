<?php
        ...
        $consulta=("SELECT DISTINCT id_equipo, id_interno, con.id_contrato, nombrecontrato, perfil_nombre, nombre_estado, pe.id_perfil, DATE_FORMAT (fecha_recepcion,'%d-%m-%Y') AS fecha_cre
