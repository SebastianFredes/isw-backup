<?php
                           ...
                           $consulta=("SELECT DISTINCT id_equipo, id_interno, nombrecontrato, perfil_nombre, nombre_estado, pe.id_perfil, DATE_FORMAT (fecha_inicio_revision,'%d-%m-%Y') AS fecha_in, observacion
